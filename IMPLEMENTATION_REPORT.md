...
| `cargo test --all-targets --all-features` | **21 testes aprovados, 0 falhas; 1 benchmark manual ignorado por padrão** |
...
| Auditoria visual | Aprovada; tokens globais, estados de seleção e sidebar coerentes |
