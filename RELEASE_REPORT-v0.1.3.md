# Relatório de release — Rovex v0.1.3
...
A v0.1.3 corrige a falha observada em ambiente real na descoberta dos backends de conversão, consolidando os aprimoramentos da v0.1.2 de toolbar, Known Folders e sidebar. A UI usa componentes locais `RovexButton` e `RovexLineEdit`, evitando dependência visual de controles nativos claros. O menu contextual é aberto por clique direito em uma linha e mantém as ações habilitadas conforme a natureza e a extensão da entrada.
