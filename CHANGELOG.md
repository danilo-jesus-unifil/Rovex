...
As conversões dependem de `ffmpeg` e `ffprobe` instalados no `PATH`. No ambiente de desenvolvimento, o backend validado foi FFmpeg/ffprobe 6.1.1 do Ubuntu 24.04, com libjxl, libopus, PNG e FLAC disponíveis.
