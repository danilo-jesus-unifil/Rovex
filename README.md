...
| Pacote portable Windows | Implementado em ZIP v0.1.25 com manifesto e SHA-256 |
...
./scripts/verify_windows_portable.sh dist/rovex-v0.1.25-windows-x86_64-portable.zip
./scripts/test_verify_windows_portable.sh dist/rovex-v0.1.25-windows-x86_64-portable.zip
